...
export default {
  getData: {
    ...
    url: e.base + "/liveBroadcastManagement/rebroadcastList/list.json"
  },
  getHeatData: {
    method: e.type == 1 ? "GET" : "GET",
    url: e.base + "/liveBroadcastManagement/rebroadcastList/heatList.json"
  },
  getGiftData: {
    method: e.type == 1 ? "GET" : "GET",
    url: e.base + "/liveBroadcastManagement/rebroadcastList/giftList.json"
  },
  getByIdData: {
    method: e.type == 1 ? "GET" : "GET",
