<template>
  ...
  >
    ...
    <monitor-edit ref="monitorEdit"></monitor-edit>
...
export default {
  ...
  computed: {
    tableData() {
      return this.$store.state.monitor.tableData;
    },
    searchData() {
      return this.$store.state.monitor.searchData;
    },
    tableLoading() {
      return this.$store.state.monitor.tableLoading;
    },
    current() {
      return this.$store.state.monitor.current;
    },
    page_size() {
      return this.$store.state.monitor.page_size;
    },
    total() {
      return this.$store.state.monitor.total;
    },
    pageWait() {
      return this.$store.state.monitor.pageWait;
    }
  },
  components: {
    monitorEdit,
