...
export default {
    ...
    return {
      table: {
        columns: [
          ...
          { title: "支付方式", key: "zffs", align: "center" },
  ...
  computed: {
    tableData() {
      return this.$store.state.normalUser.rechargeTableData.tableData;
    },
    searchData() {
      return this.$store.state.normalUser.rechargeTableData.searchData;
    },
    tableLoading() {
      return this.$store.state.normalUser.tableLoading;
    },
    current() {
      return this.$store.state.normalUser.rechargeTableData.current;
    },
    page_size() {
      return this.$store.state.normalUser.rechargeTableData.page_size;
    },
    total() {
      return this.$store.state.normalUser.rechargeTableData.total;
    },
    pageWait() {
  ...
  created() {
    this.$store.dispatch({
      type: "normalUser/rechargeRefreshData"
    });
  },
  methods: {
    searchMember() {
