...
const apiInfo = api.SMSManagement.businessQueueList;
export default {
  ...
  sendInfo: (state, getters, rootState, rootGetters) => option => {
    return {
      method: apiInfo.sendInfo.method,
      url: apiInfo.sendInfo.url,
      data: {
        id: option.id
      }
    };
