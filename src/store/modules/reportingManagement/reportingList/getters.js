...
const apiInfo = api.reportingManagement.reportingList;
export default {
  ...
  warning: (state, getters, rootState, rootGetters) => option => {
    return {
      method: apiInfo.warning.method,
      url: apiInfo.warning.url
    };
  },
